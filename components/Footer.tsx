    ...
    <>
      <footer className="bg-gray-900 text-white py-10 relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li>
                    <p className="text-gray-300 mb-2">
                      <strong>Email:</strong>{" "}
                      <Link href="mailto:keongsumbermakmur@aol.com" className="text-blue-500 hover:text-blue-700">
                  ...
                  <li>
                    <p className="text-gray-300 mb-2">
                      ...
                      <Link href="https://wa.me/628123279332" className="text-blue-500 hover:text-blue-700" target="_blank" rel="noopener noreferrer">
                        +628123279332
                      </Link>
                    </p>
                  </li>
            ...
            <div>
              ...
              <div className="flex space-x-6 text-gray-400">
                <Link href="https://www.facebook.com/keongsm" target="_blank" rel="noopener noreferrer" className="hover:text-white">
                  <Facebook size={24} />
                </Link>
                <Link href="https://twitter.com/keongsm" target="_blank" rel="noopener noreferrer" className="hover:text-white">
                  <Twitter size={24} />
                </Link>
                <Link href="https://www.instagram.com/keongsumbermakmur/" target="_blank" rel="noopener noreferrer" className="hover:text-white">
                  <Instagram size={24} />
                </Link>
                <Link href="https://www.linkedin.com/company/keongsm" target="_blank" rel="noopener noreferrer" className="hover:text-white">
                  <Linkedin size={24} />
                </Link>
              </div>
            </div>
        ...
        <div className="fixed bottom-5 right-5">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-10 h-10" fill="currentColor">
